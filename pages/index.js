    ...
    <div className={styles.background}>
      ...
      {!session ? (
        <h1 className="block mb-2 text-sm font-large text-gray-900 dark:text-gray-300 text-center">
          To create Projects and more, please Sign In with your GitHub Account
        </h1>
      ) : (
        <>
        <div className="flex justify-center">
          <form onSubmit={saveProject}>
            ...
            <button
              type="submit"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 m-5"
              >
              Add Project
            </button>
          </form>
              ...
              <li className="m-5" key={item.id}>
                ...
                <button
                  onClick={async () => {
                    ...
                    setProjects(projects.filter((prj) => prj !== item));
                  }}
